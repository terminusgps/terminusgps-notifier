            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        help_text="Enter a sub total as a decimal.",
                        max_digits=12,
                    ),
                ),
                (
                    ...
                    models.GeneratedField(
                        ...
                        expression=django.db.models.expressions.CombinedExpression(
                            django.db.models.expressions.CombinedExpression(
                                ...
                                "*",
                                django.db.models.expressions.CombinedExpression(
                                    models.F("tax_rate"), "+", models.Value(1)
                                ),
                            ),
                            "-",
                            models.F("sub_total"),
                ...
                (
                    ...
                    models.GeneratedField(
                        ...
                        help_text="Automatically generated grand total amount (sub+tax).",
                        output_field=models.DecimalField(
                            decimal_places=2, max_digits=12
                        ),
                    ),
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        default=None,
                        help_text="Select an Authorizenet subscription from the list.",
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="notifier_customer",
                        to="terminusgps_payments.subscription",
                    ),
                ),
                (
                    "user",
                ...
                (
                    ...
                    models.OneToOneField(
                        blank=True,
                        default=None,
                        help_text="Select a Wialon API token from the list.",
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="notifier_customer",
                        to="terminusgps_notifier.wialontoken",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="terminusgps_notifier.terminusgpsnotifiercustomer",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "e",
                    models.IntegerField(
                        blank=True, default=1, verbose_name="enabled"
                    ),
                ),
                ...
                (
                    "la",
                    models.CharField(blank=True, default="en", max_length=2),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="terminusgps_notifier.wialonresource",
                    ),
                ),
            ],
            options={
